...
- 크기 4종: 스토리 9:16 · 피드 4:5 · 정사각 1:1 · **링크 프리뷰 1200×628 (1.91:1, `drawLandscape` — 왼쪽 유형 이름·설명·브랜드 / 오른쪽 지도+주소)**
...
- 🔴 **지도형이 기본이다** (`layout=map`, 같은 날 추가). 경제(x)×사회·문화(y) 평면에 **좌표 있는 의원 전원(292)을 익명 회색 점**으로 뿌리고
