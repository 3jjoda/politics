...
- **분석 탭** (기본 활성):
  ...
  표결 성향 (전체폭 2단, 474)
  overview-grid.three : 월별 발의(1.3fr) | 주요 법안 이력(1fr) | 대표발의 관심분야(1fr)
  회의 발언 기록 (전체폭)
  ```
...
- 엔드포인트 2개 (`routes/ApiRoutes.js`):
  `GET /api/politician/:monaCd/bills?kind=all|rep|co&page=N` · `GET /api/politician/:monaCd/votes?ym=YYYY-MM`
