...
const TOPIC_KEYWORDS = {
    ...
    '행정/공공/사법': ['공무원', '지방자치', '공공기관', '민원', '행정심판', '행정절차', '사법', '법원', '헌법재판소', '검찰', '감사원', '공직자윤리', '국민권익', '경찰', '징벌적배상', '정부조직', '주민등록', '민방위', '전자정부', '공익신고자', '부패방지', '지방행정동우회', '지방공기업', '국가공무원', '지방공무원', '공익법인', '공정채용', '법률구조', '법무사', '세무사', '통계법', '헌법재판소법', '국무총리', '국무위원', '정부위원', '출석요구', '운영위원장', '사임', '법무행정관', '경찰제복', '특정중대범죄 피의자 등 신상정보 공개'],
    ...
    '통일/외교/남북': ['북한', '남북교류', '통일', '재외국민', '외교', '위안부', '강제동원', '북한이탈주민', '판문점', '개성공단', '한미동맹', '일본정부', '남북관계', '북핵', '미얀마', '우크라이나', '쿠르드', '해외이주', '국제연합', '대일항쟁기', '겨레말큰사전', '남북협력기금', '독립유공자', '6·25', '종전선언', '역사왜곡', '한·아랍재단', '북한주민 모자보건'],
    '정치/선거/규제': ['공직선거', '국회', '국민투표', '정당', '규제', '특별검사', '징계안', '탄핵소추', '윤석열', '김건희', '비상계엄', '헌법', '대통령', '사법농단', '선거관리위원회', '정치자금', '인사청문', '법무부장관', '국회의원(징계)', '대통령직인수', '행정안전부장관', '공직자', '공직선거법', '고위공직자범죄수사처', '개헌절차', '국회운영위원장', '국무총리', '국무위원', '정부위원', '출석요구', '국가법안', '국회상설소위원회', '국민참여', '국민공휴일', '정치', '선거', '사임의 건', '의사일정', '출석요구', '국민소환', '특별감찰관', '전직대통령 예우'],
    ...
    '99': ['일부개정법률안', '전부개정법률안', '법률안', '특별법안', '기본법안', '폐지법률안', '결의안', '징계안', '의사일정', '출석요구', '사임의 건', '국무총리', '정부위원'] // 국회 절차 관련 키워드 최종 제외
};
